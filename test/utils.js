  ...
  describe("utils", function() {
    describe("typeOf", function() {
      it("should correctly identify a string", function() {
        return Utils.typeOf("true").should.equal("string");
      });
      it("should correctly identify a boolean", function() {
        return Utils.typeOf(true).should.equal("boolean");
      });
      it("should correctly identify a object", function() {
        return Utils.typeOf({}).should.equal("object");
      });
      it("should correctly identify a function", function() {
        return Utils.typeOf(function() {}).should.equal("function");
      });
      it("should correctly identify a regex", function() {
        return Utils.typeOf(/an/).should.equal("regexp");
      });
      it("should correctly identify a number", function() {
        return Utils.typeOf(9).should.equal("number");
      });
      it("should correctly identify a date", function() {
        return Utils.typeOf(new Date()).should.equal("date");
      });
      it("should identify undefined objects", function() {
        return Utils.typeOf().should.equal("undefined");
      });
      return it("should identify null objects", function() {
        return Utils.typeOf(null).should.equal("null");
      });
    });
    describe("cloneObject", function() {
      it("should return an object with the same properties", function() {
        ...
        return clone.should.have.property("secondKey", "secondValue");
      });
      it("should return an object without the except properties", function() {
        ...
        return clone.should.have.property("firstKey", "firstValue");
      });
      it("should do a recursive clone", function() {
        ...
        return clone.firstObject.secondObject.should.have.property("thirdObject", "thirdValue");
      });
      ...
      return it("should deal with circular references", function() {
        var clone, original;
        original = {
          firstKey: "firstValue"
        };
    ...
    describe("mergeObjects", function() {
      it("should perform a basic merge", function() {
        ...
        return destination.should.have.property("secondKey", "secondValue");
      });
      ...
      it("should do a recursive merge", function() {
        ...
        return destination.firstObject.secondObject.should.have.property("thirdKey", "thirdValueChanged");
      });
      return it("should deal with circular references", function() {
        var destination, source;
        destination = {
        ...
        return destination.secondKey.should.be.an("object");
      });
    });
    return describe("filterObject", function() {
      it("should filter base keys", function() {
        ...
        return testObject.should.have.property("secondKey", "secondValue");
      });
      it("should filter recursively", function() {
        ...
        return testObject.firstObject.secondObject.should.have.property("thirdObject", "[FILTERED]");
      });
      it("should deal with circular references", function() {
        ...
        return original.secondKey.should.be.an("object");
      });
      return it("should deal with circular references", function() {
        var original;
        original = {
