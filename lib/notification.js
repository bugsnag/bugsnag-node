...
module.exports = Notification = (function() {
  ...
  function Notification(bugsnagError, options) {
    ...
    console.log((_ref12 = options.severity, __indexOf.call(SUPPORTED_SEVERITIES, _ref12) >= 0));
    if ((options.severity != null) && __indexOf.call(options.severity, SUPPORTED_SEVERITIES) >= 0) {
