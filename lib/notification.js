...
module.exports = Notification = (function() {
  ...
  Notification.prototype.processRequest = function(req) {
    var _base, _base1, _base2, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    ...
    return (_base2 = this.events[0]).userId || (_base2.userId = req.headers["x-forwarded-for"] || ((_ref10 = req.connection) != null ? _ref10.remoteAddress : void 0));
  };
